"""T15 Attention —— 路径 4：cuTile Python（官方 FMHA 能力实测 + 层级 N/A 说明）。
...
T15 学习变量是“朴素计算图映射”；官方示例是 flash/online-tiled 层，因此该路径仍记
  层级 N/A，但已实测官方能力可达。
"""
...
def main():
    ...
    for causal in (False, True):
        ...
        summarize_error(out, ref, f"cutile_t15_fmha_causal{causal}", tolerance=TOL)
    print(f"[cutile_t15] official FMHA capability run PASS; layer note: official sample is flash/online-tiled layer (not T15 naive layer)")
