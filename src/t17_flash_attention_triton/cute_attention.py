"""T17 Attention —— 路径 5：CUTLASS CuTe DSL（官方 flash_attention_v2 能力实测 + 层级 N/A）。
...
官方示例是 CuTe/CUTLASS 框架 flash 层（非 T17 Triton tutorial 路径），机制记 N/A；能力已实测。
"""
...
def main():
    ...
    print("[cute_t17] official flash_attention_v2 capability run PASS")
    print("[cute_t17] layer note: official example is CuTe/CUTLASS framework flash layer (not T17 Triton path)")
