"""T18 Attention —— 路径 4：cuTile Python（官方 FMHA 能力实测 + 层级 N/A 说明）。
...
T18 学习变量是 Triton tutorial 的 FA 教学版；官方示例是框架 flash 层，因此路径记
  层级 N/A，但官方能力已实测通过。
"""
...
def main():
    ...
    for causal in (False, True):
        ...
        summarize_error(out, ref, f"cutile_t18_fmha_causal{causal}", tolerance=TOL)
    print(f"[cutile_t18] official FMHA capability run PASS; layer note: official sample is framework flash layer (not T18 Triton tutorial path)")
